...
-- Combines migrations 002 → 017 in order. Idempotent.
-- ============================================================
-- USE: Create new Supabase project at supabase.com → SQL editor →
--      paste this entire file → Run. Then update Spine's env vars
--      in Coolify with the new project URL + service-role key.
-- ============================================================
